...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-96">
        <h2 class="text-2xl font-bold mb-6 text-center text-gray-600">EduSync - Connexion</h2>
        ...
        <form action="../scripts/authprocess.php" method="POST" class="space-y-4">
            ...
            <button type="submit" name="login" class="w-full bg-gray-500 text-white p-2 rounded-md hover:bg-blue-700 transition duration-200">
                Se connecter
            </button>
